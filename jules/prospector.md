...
- ~~Highest-quality variant resolution: picking the densest srcset/CDN candidate rather than what the page loaded~~ — RFC filed: #223 (go, staged; implementation is Scout's)
