...
## 2026-08-20 - Empty states teach interaction models
**Learning:** The empty state is a valuable surface for discovering hidden alternative interaction models (like Alt+Click and drag-to-save). By using localized hints, these features become more discoverable without cluttering the active UI.
**Action:** Add concise, localized instructional text below the primary empty state message to guide users towards alternative power-user workflows.
