...
## 2026-08-02 - Parser Differential Vulnerability in IPC URL Handlers
**Vulnerability:** Validating a URL using `new URL()` but passing the raw, un-normalized string to `browser.downloads.download()`, which allows parser differentials to bypass protocol checks.
