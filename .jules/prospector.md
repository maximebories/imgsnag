...
## 2026-09-06 - Deliverable terminology correction
**Learning:** In a previous run, a design sketch in the PR body was incorrectly described as a "prototype". A prototype implies working, validated code (even if throwaway). Describing a design sketch as a prototype changes how much an implementer trusts it.
**Action:** Do not describe a design sketch as a prototype. Use precise terminology to accurately convey the validation level of the proposed mechanism.
